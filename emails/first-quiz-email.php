...
function villegas_get_first_quiz_email_content( array $quiz_data, WP_User $user ): array {
  ...
  table[id$="villegas-email-card"] {
    ...
    $body .= '<tr>';
    $body .= '<td style="text-align:center;padding-bottom:20px;">';
    $body .= '<p style="color:red;font-weight:bold;font-size:20px;margin:0;">';
    $body .= 'WORKING — STRUCTURE UPDATED';
    $body .= '</p>';
    $body .= '</td>';
    $body .= '</tr>';
    $body .= '<tr>';
    $body .= '<td>';
    $body .= '<table class="villegas-circle-wrapper" role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">';
    $body .= '<tr>';
    $body .= '<td class="villegas-circle-container villegas-first-circle" style="text-align:center;padding:0 14px;">';
    ...
    $body .= '</td>';
    $body .= '<td id="villegas-final-title-row" class="villegas-circle-container" style="text-align:center;padding:0 14px;">';
