...
function villegas_get_final_quiz_email_content( array $quiz_data, WP_User $user ): array {
  ...
  @media only screen and (max-width:480px) {
    ...
    $body  = $inline_styles;
    $body .= '<table id="villegas-final-wrapper" role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0"' . $wrapper_background_attr . ' style="' . $wrapper_background_style . '">';
    $body .= '<tr>';
